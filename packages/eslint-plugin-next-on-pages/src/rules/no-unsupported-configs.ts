...
// configs taken from https://github.com/khulnasoft/next-on-pages/blob/main/packages/next-on-pages/docs/supported.md#nextconfigjs-properties
...
const rule: Rule.RuleModule = {
	...
	meta: {
		...
		fixable: 'code',
		docs: {
			url: 'https://github.com/khulnasoft/next-on-pages/blob/main/packages/eslint-plugin-next-on-pages/docs/rules/no-unsupported-configs.md',
		},
	},
};
