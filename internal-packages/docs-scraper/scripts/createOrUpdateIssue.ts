...
function generateRememberToUpdateSection(): string {
	...
	rememberToUpdateSection +=
		'> - [The supported documentation](https://github.com/khulnasoft/next-on-pages/blob/main/packages/next-on-pages/docs/supported.md#nextconfigjs-properties)\n';
	rememberToUpdateSection +=
		'> - [The eslint-plugin-next-on-pages no-unsupported rule](https://github.com/khulnasoft/next-on-pages/blob/main/packages/eslint-plugin-next-on-pages/src/rules/no-unsupported-configs.ts)\n';
